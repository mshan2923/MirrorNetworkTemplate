...
namespace Mirror
{
    ...
    public static class NetworkClient
    {
        ...
        static void ClearNullFromSpawned()
        {
            ...
            // can't modify NetworkServer.spawned inside foreach so need 2nd loop to remove
        ...
        public static void DestroyAllClientObjects()
        {
            ...
            catch (InvalidOperationException e)
            {
                ...
                Debug.LogError("Could not DestroyAllClientObjects because spawned list was modified during loop, make sure you are not modifying NetworkServer.spawned by calling NetworkServer.Destroy or NetworkServer.Spawn in OnDestroy or OnDisable.");
            }
        }
